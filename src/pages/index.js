    ...
    <Section id="A propos" dark>
      ...
      <Flex alignItems="center" flexDirection="column">
        <Box px={2} width={[1, 1 / 2]}>
          <p>
            blablablablablablablablablaablablablablablablablablaablablabla
            blablablablablaablablablablablablablabl
            aablablablablablablablablaablablablablablablablabla
          </p>
        </Box>
      </Flex>
    </Section>
...
export const pageQuery = graphql`
  query indexQuery {
    ...
    hero: allImageSharp(filter: { original: { src: { regex: "/forest/" } } }) {
      edges {
        node {
          id
          fluid(quality: 100) {
